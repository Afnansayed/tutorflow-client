...
const categories = [
  { name: "Mathematics", count: "120+ Tutors", icon: Calculator, color: "text-blue-500" },
  { name: "Science", count: "85+ Tutors", icon: Atom, color: "text-purple-500" },
  { name: "Programming", count: "200+ Tutors", icon: Code, color: "text-emerald-500" },
  { name: "Languages", count: "150+ Tutors", icon: Languages, color: "text-orange-500" },
  { name: "Digital Art", count: "45+ Tutors", icon: Palette, color: "text-pink-500" },
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {categories.map((cat, index) => (
            <motion.div
              ...
              whileHover={{ y: -5 }}
              className="group p-6 rounded-[2rem] bg-secondary border border-primary/5 flex items-center justify-between hover:shadow-xl hover:shadow-primary/5 transition-all cursor-pointer"
            >
              <div className="flex items-center gap-5">
                <div className="w-14 h-14 rounded-2xl bg-white shadow-sm flex items-center justify-center group-hover:bg-primary group-hover:text-white transition-all">
                  <cat.icon size={28} className={cat.color + " group-hover:text-white"} />
                </div>
                <div>
