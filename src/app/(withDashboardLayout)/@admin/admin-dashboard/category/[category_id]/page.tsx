...
const UpdateCategory = () => {
  ...
  const { data: categoryResponse, isLoading: isFetching } =
    useGetCategoriesByIdQuery(category_id);
      ...
      <div className="bg-white rounded-[2.5rem] border border-slate-100 shadow-sm p-10">
        <div className="mb-10 text-center">
          ...
          <p className="text-slate-500 text-sm mt-1 font-medium">
            Modify category details and thumbnail
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          <div className="space-y-2">
            ...
            <input
              ...
              className="w-full px-5 py-4 bg-slate-50 border border-slate-200 rounded-2xl text-slate-800 focus:outline-none focus:border-primary/50 focus:bg-white transition-all font-medium"
            />
            {errors.name && (
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              className="w-full px-5 py-4 bg-slate-50 border border-slate-200 rounded-2xl text-slate-800 focus:outline-none focus:border-primary/50 focus:bg-white transition-all font-medium uppercase"
            />
            {errors.sub_code && (
          ...
          <div className="flex items-center gap-4 pt-4">
            ...
            <button
              disabled={loading}
              type="submit"
              className="flex-[2] py-4 bg-primary hover:bg-[#1e7da0] text-white rounded-2xl font-bold text-sm transition-all shadow-md shadow-primary/10 flex items-center justify-center gap-2 disabled:opacity-70"
            >
              {loading ? (
